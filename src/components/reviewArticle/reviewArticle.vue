  ...
  <div>
    ...
    <div class="bigBox">
      ...
      <div class="button">
        ...
        <!--          通过-->
        <el-button type="primary" size="small" icon="el-icon-check" :disabled="templateSelection>-1?false:true">通过</el-button>
        <!--        顶置-->
        <el-button type="primary" size="small" icon="el-icon-time" :disabled="templateSelection>-1?false:true">顶置</el-button>
        <!--        取消顶置-->
        <el-button type="primary" size="small" icon="el-icon-time" :disabled="templateSelection>-1?false:true">取消顶置</el-button>
      </div>
